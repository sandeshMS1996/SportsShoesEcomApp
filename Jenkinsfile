    ...
    stages {
        stage('Build') {
            ...
            post {
                ...
                sh 'sudo scp -v -o StrictHostKeyChecking=no -i /home/ec2-user/ProdServer.pem target/*.jar ubuntu@ec2-3-137-201-53.us-east-2.compute.amazonaws.com:/home/ubuntu'
